...
function searchHandler(currIdx, listSize, dir) {
    var realDir = dir === 40;
    var realIdx = currIdx !== -1 ? currIdx : null;
    var idx = void 0;
    if (realIdx === null) {
...
function typeAhead(search) {
    ...
    searchInput.on('input', function () {
        ...
        axios.get('/api/search?q=' + this.value).then(function (res) {
            ...
            searchResults.innerHTML = dompurify.sanitize('<div class=\'search__result\'>No results for ' + _this.value + '</div>');
        });
    });
    ...
    searchInput.on('keyup', function (e) {
        ...
        var results = Array.from(searchResults.children);
        var currIdx = results.findIndex(function (i) {
            return i.classList.contains(activeClass);
        });
        ...
        if ([38, 40].includes(e.keyCode)) {
            var idx = searchHandler(currIdx, resSize, e.keyCode);
